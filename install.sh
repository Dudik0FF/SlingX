...
then
   ...
   mkdir /home/mini_cs && wget https://github.com/DRM-Panel/SlingX/raw/main/directsling.tar.gz -O /home/mini_cs/mini_cs.tar.gz && cd /home/mini_cs && tar zxvf mini_cs.tar.gz && scripts/setup.sh && scripts/ramdisk_all.sh && scripts/start.sh
fi
...
then
   echo "wwwdir missing!"
   mkdir /home/wwwdir/config && wget https://github.com/DRM-Panel/SlingX/raw/main/slingjson.zip -O /home/wwwdir/config/slingjson.zip  
fi

if [ ! -d /home/wwwdir/css ] 
then
   echo "wwwdir missing!"
   mkdir /home/wwwdir/css && wget https://github.com/DRM-Panel/SlingX/raw/main/css.zip -O /home/wwwdir/css/css.zip  
fi

if [ ! -d /home/wwwdir/scripts ] 
then
   echo "wwwdir missing!"
   mkdir /home/wwwdir/scripts && wget https://github.com/DRM-Panel/SlingX/raw/main/scripts.zip -O /home/wwwdir/scripts/scripts.zip  
fi
...
wget https://github.com/DRM-Panel/SlingX/raw/main/scripts.zip -O /home/wwwdir/scripts/scripts.zip
wget https://github.com/DRM-Panel/SlingX/raw/main/slingjson.zip -O /home/wwwdir/config/slingjson.zip
wget https://github.com/DRM-Panel/SlingX/raw/main/sling.zip -O /home/wwwdir/sling.zip
wget https://github.com/DRM-Panel/SlingX/raw/main/SLINGHD.zip -O /home/SLING/SLINGHD.zip
